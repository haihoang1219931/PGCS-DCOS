...
#include "../src/Controller/Com/SerialLink.h"
...
QT_INIT_METAOBJECT const QMetaObject SerialConfiguration::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SerialConfiguration.data,
...
QT_MOC_LITERAL(3, 29, 19), // "communicationUpdate"
QT_MOC_LITERAL(4, 49, 5), // "error"
QT_MOC_LITERAL(5, 55, 6), // "params"
QT_MOC_LITERAL(6, 62, 18), // "communicationError"
QT_MOC_LITERAL(7, 81, 9), // "linkError"
QT_MOC_LITERAL(8, 91, 28), // "QSerialPort::SerialPortError"
QT_MOC_LITERAL(9, 120, 15), // "closeConnection"
QT_MOC_LITERAL(10, 136, 12), // "connect2host"
QT_MOC_LITERAL(11, 149, 9), // "readyRead"
QT_MOC_LITERAL(12, 159, 9), // "connected"
QT_MOC_LITERAL(13, 169, 12), // "disconnected"
QT_MOC_LITERAL(14, 182, 17) // "connectionTimeout"

    },
    "SerialLink\0aboutToCloseFlag\0\0"
    "communicationUpdate\0error\0params\0"
    "communicationError\0linkError\0"
    "QSerialPort::SerialPortError\0"
    "closeConnection\0connect2host\0readyRead\0"
    "connected\0disconnected\0connectionTimeout"
};
#undef QT_MOC_LITERAL
...
void SerialLink::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->communicationUpdate((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 2: _t->communicationError((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 3: _t->linkError((*reinterpret_cast< QSerialPort::SerialPortError(*)>(_a[1]))); break;
        case 4: _t->closeConnection(); break;
        case 5: _t->connect2host(); break;
        case 6: _t->readyRead(); break;
        case 7: _t->connected(); break;
        case 8: _t->disconnected(); break;
        case 9: _t->connectionTimeout(); break;
        default: ;
        }
    } else if (_c == QMetaObject::RegisterMethodArgumentMetaType) {
        switch (_id) {
        ...
        {
            using _t = void (SerialLink::*)(QString , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialLink::communicationUpdate)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (SerialLink::*)(QString , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialLink::communicationError)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void SerialLink::communicationUpdate(QString _t1, QString _t2)
{
...
// SIGNAL 2
void SerialLink::communicationError(QString _t1, QString _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
