...
#include "../src/Maplib/Marker/Marker.h"
...
QT_MOC_LITERAL(1, 7, 8), // "latitude"
QT_MOC_LITERAL(2, 16, 10), // "longtitude"
QT_MOC_LITERAL(3, 27, 11), // "description"
QT_MOC_LITERAL(4, 39, 9), // "elevation"
QT_MOC_LITERAL(5, 49, 10) // "markerType"

    },
    "Marker\0latitude\0longtitude\0description\0"
    "elevation\0markerType"
};
...
void Marker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->latitude(); break;
        case 1: *reinterpret_cast< QString*>(_v) = _t->longtitude(); break;
        case 2: *reinterpret_cast< QString*>(_v) = _t->description(); break;
        case 3: *reinterpret_cast< QString*>(_v) = _t->elevation(); break;
        case 4: *reinterpret_cast< QString*>(_v) = _t->markerType(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setLatitude(*reinterpret_cast< QString*>(_v)); break;
        case 1: _t->setLongtitude(*reinterpret_cast< QString*>(_v)); break;
        case 2: _t->setDescription(*reinterpret_cast< QString*>(_v)); break;
        case 3: _t->setElevation(*reinterpret_cast< QString*>(_v)); break;
        case 4: _t->setMarkerType(*reinterpret_cast< QString*>(_v)); break;
        default: break;
        }
...
QT_INIT_METAOBJECT const QMetaObject Marker::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Marker.data,
