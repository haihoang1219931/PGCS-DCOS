...
Rectangle {
    ...
    property string fileMode: "FILE_SAVE"
    ...
    Rectangle{
        id: rectCurrentFileName
        anchors.top: lblTitle.bottom
        anchors.left: parent.left
        anchors.right: parent.right
        anchors.margins: 4
        height: fileMode === "FILE_SAVE"? UIConstants.sRect+8:0
        visible: fileMode === "FILE_SAVE"
...
//                            console.log("Load folder: "+folders.folder);
    ...
    ListView{
        ...
        anchors.top: rectCurrentFileName.bottom
        anchors.right: parent.right
