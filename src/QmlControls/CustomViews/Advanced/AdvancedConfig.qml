      ...
      Repeater {
            ...
            model: ListModel {
                Component.onCompleted: {
                    append({id_: 0, btnText_: buttonListName["TAB_CONFIG_EO"][UIConstants.language[UIConstants.languageID]],
                               icon_: "\uf185", active_: true ,info_:"config_eo"});
                    append({id_: 1, btnText_: buttonListName["TAB_CONFIG_IR"][UIConstants.language[UIConstants.languageID]],
                               icon_: "\uf186", active_: false ,info_:"config_ir" });
                    append({id_: 2, btnText_: buttonListName["TAB_CONFIG_VIDEO"][UIConstants.language[UIConstants.languageID]],
                               icon_: "\uf02b", active_: false ,info_:"video" });
                    append({id_: 3, btnText_: buttonListName["TAB_CONFIG_MOTIONC"][UIConstants.language[UIConstants.languageID]],
                               icon_: "\uf0b2", active_: false ,info_:"motionc" });
                    append({id_: 4, btnText_: buttonListName["TAB_CONFIG_SEARCH"][UIConstants.language[UIConstants.languageID]],
