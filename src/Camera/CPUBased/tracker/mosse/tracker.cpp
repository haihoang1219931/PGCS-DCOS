...
void Tracker::InitTracker(const cv::Mat &input_image, cv::Point topLeft, cv::Point bottomRight)
...
void Tracker::InitTracker(const cv::Mat &input_image, cv::Rect input_rect)
{//Init tracker from user selection
...
void Tracker::Track(const cv::Mat &input_image)
{
