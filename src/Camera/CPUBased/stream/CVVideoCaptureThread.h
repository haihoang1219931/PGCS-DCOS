...
class CVVideoCaptureThread : public QObject
{
    ...
    Q_SIGNALS:
        ...
        void readyToRead();
        void objectFound(int x, int y, int width, int height, int trackWidth, int trackHeight);
        void objectLost();
    ...
    public Q_SLOTS:
        ...
        void slObjectLost();
        void slObjectFound(int x, int y, int width, int height, int trackWidth, int trackHeight);
