...
namespace Eye
{
    ...
    public:
        ...
        inline math::Matrix toMatrix() const
        {
            ...
            data_type _sin = sin(m_rot);
            math::Matrix res(3,3);
            res(0, 0) = m_scale*_cos; res(0, 1) = m_scale*_sin; res(0, 2) = m_tx;
            res(1, 0) = -m_scale*_sin; res(1, 1) = m_scale*_cos; res(1, 2) = m_ty;
        ...
        inline math::Matrix toMatrix(math::Matrix &_md) const
        {
            ...
            data_type _cos = cos(m_rot);
            data_type _sin = sin(m_rot);
            _md(0, 0) = m_scale*_cos; _md(0, 1) = m_scale*_sin; _md(0, 2) = m_tx;
            _md(1, 0) = -m_scale*_sin; _md(1, 1) = m_scale*_cos; _md(1, 2) = m_ty;
            _md(2, 0) = 0; _md(2, 1) = 0; _md(2, 2) = 1;
        }
