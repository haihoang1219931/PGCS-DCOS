...
namespace Eye{
    ...
    public:
        ...
        MotionImage(const index_type _index, const MData &_motionContext, const MData &_motionStab){
            m_index = _index;
        ...
        void setMotionStab(const MData &_motionStab){
            m_motionStab = _motionStab;
        }

        void setIndex(const index_type &_index){
            m_index = _index;
        }
        ...
        MData getMotionContext(){
            return m_motionContext;
        }
        ...
        MotionImage* parse(std::vector<byte> _data, index_type _index = 0){
            ...
            m_motionStab.parse(data, _index + sizeof(index_type) + m_motionContext.size());
            return this;
        }
        ...
        MotionImage* parse(byte *_data, index_type _index = 0){
            ...
            m_motionStab.parse(_data, _index + sizeof(index_type) + m_motionContext.size());
            return this;
        }
