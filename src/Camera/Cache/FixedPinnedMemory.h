#ifndef FIXEDPINNEDMEMORY_H
#define FIXEDPINNEDMEMORY_H
...
class FixedPinnedMemory
{
    public:
        explicit FixedPinnedMemory(size_t _maxSize, size_t _imgSize) : m_maxSize(_maxSize), m_imgSize(_imgSize)
        {
            m_head = 0;
