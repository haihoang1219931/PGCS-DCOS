#ifndef TRACKRESPONSE_H
#define TRACKRESPONSE_H
...
namespace Eye {
class TrackResponse : public Object {
private:
  index_type m_id;
...
public:
  ...
  TrackResponse(const index_type _id, const data_type _px, const data_type _py,
  ...
  TrackResponse(const TrackResponse &_trackResponse) {
    m_id = _trackResponse.m_id;
    m_px = _trackResponse.m_px;
    m_py = _trackResponse.m_py;
    m_width = _trackResponse.m_width;
    m_height = _trackResponse.m_height;
    m_objWidth = _trackResponse.m_objWidth;
    m_objHeight = _trackResponse.m_objHeight;
  }
  ...
  inline data_type getObjWidth() const { return m_objWidth; }

  inline data_type getObjHeight() const { return m_objHeight; }
  ...
  inline void setTrackResponse(const index_type _id, const data_type _px,
                               const data_type _py, const data_type _width,
                               const data_type _height,
                               const data_type _objWidth,
                               const data_type _objHeight) {
    m_id = _id;
    m_px = _px;
    m_py = _py;
    m_width = _width;
  ...
  inline TrackResponse &operator=(const TrackResponse &_trackResponse) {
    m_id = _trackResponse.m_id;
    m_px = _trackResponse.m_px;
    m_py = _trackResponse.m_py;
    m_width = _trackResponse.m_width;
  ...
  inline bool operator==(const TrackResponse &_trackResponse) {
    return (m_id == _trackResponse.m_id && m_px == _trackResponse.m_px &&
            m_py == _trackResponse.m_py && m_width == _trackResponse.m_width &&
            m_height == _trackResponse.m_height &&
            m_objHeight == _trackResponse.m_objHeight &&
            m_objWidth == _trackResponse.m_objWidth);
  }

  length_type size() { return 6 * sizeof(data_type) + sizeof(index_type); }

  std::vector<byte> toByte() {
    std::vector<byte> _result;
    std::vector<byte> b_id, b_px, b_py, b_width, b_height, b_objWidth,
        b_objHeight;
  ...
  TrackResponse *parse(std::vector<byte> _data, index_type _index = 0) {
    ...
    m_height = Utils::toValue<data_type>(data, _index + sizeof(index_type) +
                                                   3 * sizeof(data_type));
    m_objWidth = Utils::toValue<data_type>(data, _index + sizeof(index_type) +
                                                     4 * sizeof(data_type));
    m_objHeight = Utils::toValue<data_type>(data, _index + sizeof(index_type) +
                                                      5 * sizeof(data_type));
    return this;
  }

  TrackResponse *parse(byte *_data, index_type _index = 0) {
    ...
    m_height = Utils::toValue<data_type>(_data, _index + sizeof(index_type) +
                                                    3 * sizeof(data_type));
    m_objWidth = Utils::toValue<data_type>(_data, _index + sizeof(index_type) +
                                                      4 * sizeof(data_type));
    m_objHeight = Utils::toValue<data_type>(_data, _index + sizeof(index_type) +
                                                       5 * sizeof(data_type));
    return this;
  }
};
