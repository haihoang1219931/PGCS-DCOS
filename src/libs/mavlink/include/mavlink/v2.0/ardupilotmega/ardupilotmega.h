...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_START_ENGINE = 187,/* Start engine */

   MAV_CMD_DO_HEATER_ONOFF = 188,
...
#include "./mavlink_msg_pmu.h"
#include "./mavlink_msg_pw.h"
#include "./mavlink_msg_ecu.h"
#include "./mavlink_msg_aux_adc.h"
