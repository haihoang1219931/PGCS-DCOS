...
#define MAVLINK_MSG_ID_5000_LEN 35
#define MAVLINK_MSG_ID_5000_MIN_LEN 35

#define MAVLINK_MSG_ID_TRACKER_VTP_CRC 124
#define MAVLINK_MSG_ID_5000_CRC 124
...
#define MAVLINK_MESSAGE_INFO_TRACKER_VTP { \
    ...
    {	 { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_tracker_vtp_t, time_usec) }, \
         ...
         { "heading", NULL, MAVLINK_TYPE_FLOAT, 0, 20, offsetof(mavlink_tracker_vtp_t, heading) }, \
...
static inline uint16_t mavlink_msg_tracker_vtp_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t time_usec, int32_t lat, int32_t lon, int32_t baro, float heading, int16_t rssi, uint8_t status, uint32_t result1, uint32_t result2)
{
...
static inline uint16_t mavlink_msg_tracker_vtp_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
        mavlink_message_t* msg, uint64_t time_usec, int32_t lat, int32_t lon, int32_t baro, float heading,
...
static inline void mavlink_msg_tracker_vtp_send(mavlink_channel_t chan, uint64_t time_usec, int32_t lat, int32_t lon, int32_t baro, float heading,
		int16_t rssi, uint8_t status, uint32_t result1, uint32_t result2)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_TRACKER_VTP_LEN];
 ...
 */
static inline void mavlink_msg_tracker_vtp_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time_usec, int32_t lat, int32_t lon, int32_t baro, float heading,
		int16_t rssi, uint8_t status, uint32_t result1, uint32_t result2)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline float mavlink_msg_tracker_vtp_get_float(const mavlink_message_t* msg)
{
